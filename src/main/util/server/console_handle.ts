import { ConditionResult, ExecutePair, ExecuteProxy, ExecuteRecord, ExecuteRecordTask, ExecuteState, FeedBack, Job, JobCategory, MESSAGE_LIMIT, Parameter, Project, Record, Task } from "../../interface"
import { save_and_update } from "./server"

export class Util_Server_Console { 
    update:save_and_update
    
    constructor (_update:save_and_update){
        this.update = _update
    }
