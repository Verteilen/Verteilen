...
import { ConditionResult, ExecuteProxy, ExecuteRecord, ExecuteRecordTask, ExecuteState, ExecutionLog, FeedBack, Job, JobCategory, Log, Parameter, Preference, Project, Task } from "../../interface"
...
export class Util_Server_Log_Proxy {
    ...
    constructor(_model:[ExecuteManager, ExecuteRecord], _log:Log, _preference:Preference){
        this.model = _model
        this.logs = _log
