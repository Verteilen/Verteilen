...
export const GetFUNIQUE_GS4Project_V2_Template = (r:Project):Project => {
    const para:Parameter = {
        ...
        containers: [
            ...
            { name: "iframe_gap", meta: "CEIL( group_size / blend )", value: 5, type: DataType.Expression, runtimeOnly: false, hidden: false },
            ...
            { name: "iframe_size", meta: "CEIL( frameCount / iframe_gap )", value: 0, type: DataType.Expression, runtimeOnly: false, hidden: false },
