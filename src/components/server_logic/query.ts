...
export class ServerQuery {
    ...
    load_all_project = async ():Promise<void> => {
        const p:Promise<void> = this.backend.value.invoke('load_all_project').then((texts:Array<string>) => {
    ...
    load_project = async (uuid:string):Promise<void> => {
        ...
        const p:Promise<void> = this.backend.value.invoke('load_project', uuid).then((text:string) => {
    ...
    load_tasks = async (uuid:string):Promise<void> => {
        const p = this.backend.value.invoke(`project_module:get_tasks`, uuid).then(x => {
    ...
    load_task = async (uuid:string):Promise<void> => {
        ...
        const p:Promise<void> = this.backend.value.invoke('load_task', uuid).then((text:string) => {
    ...
    load_all_task = async ():Promise<void> => {
        const p:Promise<void> = this.backend.value.invoke('load_all_task').then((texts:Array<string>) => {
    ...
    load_jobs = async (uuid:string):Promise<void> => {
        const p = this.backend.value.invoke(`project_module:get_jobs`, uuid).then(x => {
            const p:Array<Job> = x
    ...
    load_all_job = async ():Promise<void> => {
        const p:Promise<void> = this.backend.value.invoke('load_all_job').then((texts:Array<string>) => {
    ...
    load_all_database = async ():Promise<void> => {
        const p:Promise<void> =  this.backend.value.invoke('load_all_database').then((texts:Array<string>) => {
    ...
    load_all_node = async ():Promise<void> => {
        ...
        const p:Promise<void> =  this.backend.value.invoke('load_all_node').then((texts:Array<string>) => {
